...
class CatGroup(models.Model):
    ...
    group_vat = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
...
class Category(models.Model):
    ...
    group_id = models.ForeignKey('CatGroup', null=True, blank=True, on_delete=models.SET_NULL) 
